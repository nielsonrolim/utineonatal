...
ActiveRecord::Schema.define(version: 20140924125609) do
  ...
  create_table "visits", force: true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.decimal  "head_circumference",    precision: 6, scale: 2
    t.decimal  "thoracic_perimeter",    precision: 6, scale: 2
    t.decimal  "waist_circumference",   precision: 6, scale: 2
    t.decimal  "weight",                precision: 6, scale: 2
    t.decimal  "stature",               precision: 6, scale: 2
